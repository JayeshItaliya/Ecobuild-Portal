...
from backend.enums import LoginMethodChoices, UserRoleChoices, UserTypeChoices
...
class User(AbstractUser, BaseModel):
    ...
    user_type = models.CharField(
        max_length=50, choices=UserTypeChoices.choices, default=UserTypeChoices.HOMEOWNER
    )
    login_method = models.CharField(
        max_length=50, choices=LoginMethodChoices.choices, default=LoginMethodChoices.EMAIL
    )
